            ...
            @forelse($experiences as $experience)
                <div class="bg-white rounded-lg shadow p-0 flex flex-col">
                    <div class="relative">
                        ...
                        <div class="absolute top-2 right-2 flex space-x-2">
                            ...
                            <form action="{{ route('experiences.destroy', $experience->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bg-white p-2 rounded-md shadow hover:bg-gray-100" title="Delete">
                    ...
                    <div class="p-4 flex-1 flex flex-col">
                        ...
                        <span class="mb-2 mr-60 px-3 py-1 rounded-md text-sm font-bold text-center
                        ...
                        <div class="mt-auto flex justify-between items-center">
                            <span class="text-xs text-gray-400">Posted at {{ $experience->created_at->format('n/j/Y') }}</span>
